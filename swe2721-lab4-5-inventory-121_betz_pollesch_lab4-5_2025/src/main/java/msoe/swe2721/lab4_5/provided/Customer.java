...
public class Customer {
     ...
     * @throws InvalidCustomerParameterException This exception will be thrown if the customer parameters are invalid
     */
    public Customer(String firstName, String lastName, int age, String streetAddress, String city, State state, int zip) throws InvalidParameterException, InvalidCustomerParameterException {
        super();
        ...
        if (!this.streetAddress.matches("\\d+\\s+([0-9a-zA-Z\\p{Punct}]+|[0-9a-zA-Z\\p{Punct}]+\\s[0-9a-zA-Z\\p{Punct}]+)+")) {
            throw new InvalidCustomerParameterException("Invalid street address");
        }
