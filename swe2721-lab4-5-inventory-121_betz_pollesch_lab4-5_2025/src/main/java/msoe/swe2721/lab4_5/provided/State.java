...
public enum State {
    ...
    /**
     * Determines if the given string is a valid state abbreviation.
     * @param stateStr the state abbreviation.
     * @return true if the given string is a valid state abbreviation; false otherwise.
     */
    public static boolean isValidStateAbbreviation(String stateStr) {
        try {
            State.valueOf(stateStr.toUpperCase());
            return true;
