...
public class CustomerTest {
    ...
    public void testConstructor(String firstName, String lastName, int age, String streetAddress, String city, State state, int zip, boolean exceptionExpected) throws InvalidCustomerParameterException {
        // Arrange
        Customer c;
    ...
    public Object[][] equalsDP() throws InvalidCustomerParameterException {
        return new Object[][]{
    ...
    public void testEquals(Customer c, String firstName, String lastName, int age, String streetAddress, String city, State state, int zip, boolean identical) throws InvalidCustomerParameterException {
        // Arrange
    ...
    @Test(dataProvider = "equals-data-provider", groups = {"provided"})
    public void testHashCode(Customer c, String firstName, String lastName, int age, String streetAddress, String city, State state, int zip, boolean identical) throws InvalidCustomerParameterException {
        // Arrange
        Customer newc = new Customer(firstName, lastName, age, streetAddress, city, state, zip);
    ...
    public void testToString() throws InvalidCustomerParameterException {
        // Arrange
